...
class GigagenieM(object):
    """Missing associated documentation comment in .proto file."""

    @staticmethod
    def serviceM(request_iterator,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/kt.gigagenie.ai.m.GigagenieM/serviceM',
            proto_dot_gigagenieM__pb2.reqM.SerializeToString,
            proto_dot_gigagenieM__pb2.resM.FromString,
