...
finish = 0
def media_finished(event):
    global finish
    print ("Event: media finished")
    finish = 1
...
if __name__ == '__main__':
    ...
    #player.load_audio("../data/sample_sound.wav")
    #player.play_audio()

    # VlcPlayer
    #media_url = 'http://tbs.hscdn.com/tbsradio/fm/playlist.m3u8'
    #media_url = 'http://pd.podbbang.com/podbbangdown/_pc_/multi/eng/0/2f6164636d2f31353333313931323330303036355f6133312e6d7033/0-0-0/2f64617461312f67656573696b30322f313830383039325f6133312e6d7033/0-0-0/content.mp3'
    media_url = 'test.wav'
    ...
    time.sleep(1)
    print ('play')
    vlcplayer.play(media_url)
    vlcplayer.set_end_callback(media_finished)
    #while finish == 0:
    #    sec = vlcplayer.get_time() / 1000
    #    m, s = divmod(sec, 60)
    #    print ("%02d:%02d" % (m,s))
    print ('duration')
    print (vlcplayer.get_duration())
    time.sleep(0.2)
    print (vlcplayer.get_state())
    print (vlcplayer.is_playing())
    time.sleep(5)
    print ('pause')
    vlcplayer.pause()
    time.sleep(0.2)
